...
// Database hostname:
$config['dbConnection']['host'] = 'thefacephone.ce6ojopwii3x.us-east-1.rds.amazonaws.com';
// Database username:
$config['dbConnection']['user'] = 'chirped';
// Database password:
$config['dbConnection']['pass'] = 'Chirped123!';
// Database name:
$config['dbConnection']['name'] = 'chirped';
// Database type:
